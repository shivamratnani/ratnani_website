          ...
          <div class="text-column">
            <div class="text-editor">
              ...
              <div class="editor-content">
                ...
                As a Computer Science and Data Science double major from UW-Madison (graduated May 2025), I'm passionate about building scalable solutions at the intersection of software engineering and AI. Currently, I'm driving innovation as a Fullstack Software Engineer at Expert AI, where I've stabilized critical Athena EHR integrations for 100+ physicians, migrated core infrastructure from Flask to FastAPI achieving 2x performance gains, and reduced API response times from 600ms to 200ms through optimization and async programming. My entrepreneurial spirit led me to co-found ActiveLinks, developing iOS applications in Swift/SwiftUI for 500+ beta users, and previously EduTools, an AI-powered educational platform serving 1000+ users. My experience spans full-stack development, cloud infrastructure, and AI/ML integration, with expertise in Python, JavaScript, TypeScript, FastAPI, React, Node.js, and cloud platforms (GCP, AWS, Azure). Through projects ranging from healthcare AI systems with LangChain and OpenAI to real-time data synchronization platforms, I continually challenge and tackle new problems.
              </div>
